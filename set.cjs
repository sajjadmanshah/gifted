...
const config = {
  SESSION_ID: process.env.SESSION_ID || "Gifted~Rn782TYh",
  ...
  OWNER_NUMBER: process.env.OWNER_NUMBER || "923072946127",
  SUDO_NUMBERS: process.env.SUDO_NUMBERS || "923072946127,923106367623",
